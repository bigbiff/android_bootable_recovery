...
static void process_recovery_mode(bool skip_decryption) {
...
int main(int argc, char **argv) {
	...
	twrpSocket *twrp_socket = new twrpSocket();
	TWFunc::Clear_Bootloader_Message();
	adb_bu_fifo->threadAdbBuFifo();
	twrp_socket->threadRecoverySocket();
	...
	if (startup.Get_Fastboot_Mode()) {
		...
		process_recovery_mode(startup.Should_Skip_Decryption());
	}
